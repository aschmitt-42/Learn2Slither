...
def main():
    ...
    board = Board()
    # play_multiple_visual(agent, num_games=2, max_steps=500)
    play_visual(agent, board)
    # # Mode visualisation graphique
    # if args["visual"]:
    #     if args["step_by_step"] > 1:
    #         print("Lancement de plusieurs parties avec visualisation...")
    #         play_multiple_visual(agent, num_games=args["visual_games"])
    #     else:
    #         board = Board()
    #         print("Lancement d'une partie avec visualisation...")
